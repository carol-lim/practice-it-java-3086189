...
public class MenuBuilder {
  public static void main(String[] args) {
    ...
    ArrayList<MenuItem> menu = new ArrayList<>(); // best practice to add <>

    // Create a variable called starter of type MenuItem and pass in the name of
    // your favourite starter.
    MenuItem starter = new MenuItem("Butterbeer");
    ...
    MenuItem dessert = new MenuItem("Egg tart");
